...
const OrdersPaymentProviderDetails = ({
  dateRange,
  dateRangeCompareTo,
  compareEnabled,
}: {
  ...
  >(`/orders-analytics/payment-provider`, [dateRange, dateRangeCompareTo], {
  ...
  if (data.analytics.dateRangeFrom) {
    return (
      <OrdersPaymentProviderPieChart
        ordersPaymentProviderResponse={data}
...
export const OrdersPaymentProviderCard = ({
  dateRange,
  dateRangeCompareTo,
  compareEnabled,
}: {
    ...
    <Grid container paddingBottom={2} spacing={3}>
      <Grid item xs={12} md={12}>
        <Grid container spacing={2}>
          ...
          <Grid item>
            <Heading level="h2">
              Popularidad de los proveedores de pagos
            </Heading>
          </Grid>
        </Grid>
      </Grid>
