...
const ProductsSoldCountNumbers = ({
  current,
  previous,
  compareEnabled,
}: {
  ...
  return (
    <Grid container alignItems={"center"} spacing={2}>
      <Grid item>
        <Heading level="h1">{current}</Heading>
      </Grid>
          ...
          <Grid container alignItems={"center"}>
            <Grid item>
              <IconComparison
                ...
                previous={previous ? parseInt(previous) : undefined}
              />
            </Grid>
            {previous !== undefined && (
              <Grid item>
...
export const ProductsSoldCountCard = ({
  orderStatuses,
  dateRange,
  dateRangeCompareTo,
  compareEnabled,
    ...
    <Grid container paddingBottom={2} spacing={3}>
      <Grid item xs={12} md={12}>
        <Grid container spacing={2} alignItems={"center"}>
          ...
          <Grid item>
            <Heading level="h2">Productos vendidos</Heading>
          </Grid>
        </Grid>
      </Grid>
      <Grid item xs={12} md={12}>
