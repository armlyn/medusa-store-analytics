...
const ValueColumn = ({
  ...
  return (
    <Grid container alignItems={"center"}>
      {enableComparing ? (
        <Tooltip content={`Previamente: ${previous}`}>
          <span>
            <Text
              style={{
    ...
    <Grid container spacing={2}>
      ...
      <Grid item xs={12}>
        <Grid container justifyContent={"space-between"}>
          <Grid item>
            <Heading level="h3">Nombre</Heading>
          </Grid>
          <Grid item>
        ...
        tableRows.map((tableRow) => (
          <Grid item xs={12} key={tableRow.name}>
            <Grid container justifyContent={"space-between"}>
              ...
              <Grid item>
                <ValueColumn
                  current={tableRow.current}
                  previous={tableRow.previous}
                  enableComparing={enableComparing}
                />
              </Grid>
            </Grid>
          </Grid>
