...
const RetentionCustomerRateDetails = ({
  orderStatuses,
  dateRange,
  dateRangeCompareTo,
  compareEnabled,
    ...
    return (
      <Grid container>
        <Grid item xs={12} md={12}>
          <RetentionCustomerRateNumber
            retentionCustomerRateResponse={data}
...
export const CustomersRetentionCustomerRate = ({
  orderStatuses,
  dateRange,
  dateRangeCompareTo,
  compareEnabled,
    ...
    <Grid container paddingBottom={2} spacing={3}>
      <Grid item xs={12} md={12}>
        <Grid container spacing={2}>
          ...
          <Grid item>
            <Heading level="h2">Tasa de retención de clientes</Heading>
          </Grid>
        </Grid>
      </Grid>
      <Grid item xs={12} md={12}>
        <RetentionCustomerRateDetails
