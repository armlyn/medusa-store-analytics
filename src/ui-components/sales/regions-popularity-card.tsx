...
function transformToPopularityTable(
  result: OrdersRegionsPopularityResult
): PopularityTableRow[] {
...
const RegionsPopularityDetails = ({
  orderStatuses,
  dateRange,
  dateRangeCompareTo,
  compareEnabled,
...
export const RegionsPopularityCard = ({
  orderStatuses,
  dateRange,
  dateRangeCompareTo,
  compareEnabled,
    ...
    <Grid container paddingBottom={2} spacing={3}>
      <Grid item xs={12} md={12}>
        <Grid container spacing={2}>
          ...
          <Grid item>
            <Heading level="h2">Popularidad de las regiones</Heading>
          </Grid>
        </Grid>
      </Grid>
      <Grid item xs={12} md={12}>
        <RegionsPopularityDetails
