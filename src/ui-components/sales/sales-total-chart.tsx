...
export const SalesByNewChart = ({
    ...
    current: salesHistoryResponse.analytics.current.map((currentData) => {
      return {
        ...
        value: amountToDisplay(
          parseInt(currentData.total),
          salesHistoryResponse.analytics.currencyDecimalDigits
        ),
      };
    }),
  ...
  return (
    <>
      <Heading level="h3">Ventas por tiempo</Heading>
      <ChartCurrentPrevious
        ...
        fromCompareDate={
          salesHistoryResponse.analytics.dateRangeFromCompareTo
            ? new Date(salesHistoryResponse.analytics.dateRangeFromCompareTo)
            : undefined
        }
        toCompareDate={
          salesHistoryResponse.analytics.dateRangeToCompareTo
            ? new Date(salesHistoryResponse.analytics.dateRangeToCompareTo)
            : undefined
        }
